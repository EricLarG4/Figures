...
Use Ctrl+Shift+F to search for any topic
...
## The `data.table` alternative for large dataset
and concise syntax {auto-animate="TRUE"}
...
## 1. Specify the dataset {auto-animate="TRUE"}
```{r}
#| label: ggplot_aes_1
#| echo: true
#| eval: true
...
## 2. Map variables to aesthetics {auto-animate="TRUE"}
```{r}
...
## 3. Add geometries {auto-animate="TRUE"}
...
## Non-linear models use `nls` {auto-animate="TRUE"}

xxx

## Scaling aesthetics {auto-animate="TRUE"}

colors (preset, manual)
sizes
shapes
linetypes

## Scaling axes {auto-animate="TRUE"}
