...
# Principle 1: Diagram first {background-color="#ffdae0 "}
...
# Principle 2: Use the right software {background-color="#ffdae0 "}
...
# Principle 3: Use an Effective Geometry and Show Data {background-color="#ffdae0 "}
...
# Principle 4: Colors mean something {background-color="#ffdae0 "}
...
# Principle 5: Include Uncertainty {background-color="#ffdae0 "}
...
# Principle 6: Panels {background-color="#ffdae0 "}
...
# Principle 7: Data and models are different things {background-color="#ffdae0 "}
...
# Principle 8: Simple visuals,</br>detailed captions {background-color="#ffdae0 "}
...
# Principle 9: Consider an infographic {background-color="#ffdae0 "}

Infographics typically incorporate text, images, and other diagrammatic elements

# Principle 10: Get an Opinion {background-color="#ffdae0 "}
...
# Reminders on variables,</br>data types and modes {background-color="#184669"}
