...
- Data
  ...
  - [Pre-cleaned dataset](https://raw.githubusercontent.com/EricLarG4/Figures/a10b6fdc24cfaa421b98aeae2f97544fe624bbba/data/webmd_clean.csv?token=GHSAT0AAAAAAD4ISQMEZNXUKFXHIJDANEYS2P3EGHA)
...
library(data.table)
fread(
  "https://raw.githubusercontent.com/EricLarG4/Figures/a10b6fdc24cfaa421b98aeae2f97544fe624bbba/data/webmd_clean.csv?token=GHSAT0AAAAAAD4ISQMEZNXUKFXHIJDANEYS2P3EGHA"
) |>
  _[
...
## Most presentations of x- and y-coordinate data are relationships
...
- Data
  ...
  - [Dataset used here](https://raw.githubusercontent.com/EricLarG4/Figures/refs/heads/main/data/antibes-eau-temperature-est-cap.csv?token=GHSAT0AAAAAAD4ISQMFWXQFKRDPMZXIQTJA2P3ENSQ)
  - [Pre-cleaned dataset](https://raw.githubusercontent.com/EricLarG4/Figures/refs/heads/main/data/antibes_clean.csv?token=GHSAT0AAAAAAD4ISQMEKGQSFYOGXXL4CTQE2P3ENZA)
- Remember: you can read the file directly from the URL with 
  - `read.csv()`
  - `readr::read_csv()`
  - `data.table::fread()`
